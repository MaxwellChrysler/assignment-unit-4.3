...
function listItems(){ // for loop. While first going over the assignment I was creating the functions and just writing down what I thought was the correct way to do each function. So thats why these are here
